...
[![Godoc](http://img.shields.io/badge/godoc-reference-blue.svg?style=flat)](http://godoc.org/github.com/carlosagil/elastic)
...
----------------------|------------------|------------
5.x                   | 5.0              | [`github.com/carlosagil/elastic`](https://github.com/carlosagil/elastic) ([source](https://github.com/olivere/elastic/tree/release-branch.v5) [doc](http://godoc.org/github.com/carlosagil/elastic))
...
```sh
$ go get github.com/carlosagil/elastic
```

You then import it with this import path:

```go
import elastic "github.com/carlosagil/elastic"
```
